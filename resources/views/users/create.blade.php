    ...
    <div class="content-area col-md-9">
        ...
        <div class="content-area__main">
                ...
                <div class="form-input">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-input form-check radio-inline radio-width-3">
                            <input class="form-check-input" type="radio" name="user_salutation_pid" value="{{ $salutation->parameters_id }}" {{ $i==0 ? 'checked' : '' }} nice-checkbox-radio required>
            ...
            <div class="col-md-6">
                ...
                <input name="user_profile_name" type="text" class="form-control" id="client-name" placeholder="" required>
                </div>
                </div>
            </div>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="roles_id" class="custom-select dropdown-select2" id="choose-role" required>
                    ...
                    @foreach ($roles as $role)
                        <option value="{{ $role->roles_id }}">{{ $role->roles_description }}</option>
                    @endforeach
                </select>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-input">
                    ...
                    <input name="user_name" type="text" class="form-control" id="client-email" placeholder="" required>
                </div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-input">
                    ...
                    <input name="user_phone" type="text" class="form-control" id="client-phone" placeholder="" required>
                </div>
                </div>
            </div>
            </div>
